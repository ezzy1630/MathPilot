...
9. **Backup / reset** — Export or note backup location; confirm Settings → Reset requires typing `RESET`.
10. **Data location** — Know `~/Library/Application Support/local.mathpilot.desktop/` and that quitting before sleep is enough for normal use.
